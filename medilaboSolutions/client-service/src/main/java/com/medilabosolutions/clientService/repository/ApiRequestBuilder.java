...
public class ApiRequestBuilder {
    ...
    public HttpRequest putRequest(String endpoint, String requestBody) throws URISyntaxException {
        return HttpRequest.newBuilder()
    ...
    public HttpRequest postRequest(String endpoint, String requestBody) throws URISyntaxException {
        return HttpRequest.newBuilder()
